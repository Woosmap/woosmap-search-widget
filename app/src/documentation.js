 ...
 * @property {Boolean}withDistanceMatrix to enable sorting stores using DistanceMatrixService. Default is false and stores are sorted using distances as the crow flies.
