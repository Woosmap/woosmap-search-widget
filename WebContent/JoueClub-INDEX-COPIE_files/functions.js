    ...
    SEMICOLON.header = {
        ...
        stickyMenu: function (headerOffset) {
            if ($window.scrollTop() > headerOffset) {
                if ($body.hasClass('device-lg') || $body.hasClass('device-md') || $body.hasClass('device-sm')) {
                    ...
                    $('body:not(.side-header) #content').addClass('sticky-header-content');
                    $('#page-menu:not(.dots-menu,.no-sticky)').addClass('sticky-page-menu');
                    if (!$headerWrap.hasClass('force-not-dark')) {
                        $headerWrap.removeClass('not-dark');
                    }
                    SEMICOLON.header.stickyMenuClass();
                } else if ($body.hasClass('device-xs') || $body.hasClass('device-xxs')) {
        ...
        removeStickyness: function () {
            if ($header.hasClass('sticky-header')) {
                ...
                $('body:not(.side-header) #content').removeClass('sticky-header-content');
...
$(document).ready(function () {
   ...
   // $("#widget-subscribe-form").validate();
    ...
    // RECHERCHE PAR VILLE FOOTER
    //$("#widget-ville-form").validate();


    // MEGA MENU MARQUES
    $('.menu-marques-liste-marque:not(#marque-a)').hide();
    $('.menu-marques-lettre').click(function () {
        if (!$(this).hasClass('disabled')) {
            $('.menu-marques-liste-marque').hide();
            $('#marque-' + $(this).attr('id')).show();
            $('.menu-marques-lettre').removeClass('active')
            $(this).addClass("active")
        }
    })

    // MEGA MENU HEROS
    $('.menu-heros-liste-hero:not(#hero-a)').hide();
    $('.menu-heros-lettre').click(function () {
        if (!$(this).hasClass('disabled')) {
            $('.menu-heros-liste-hero').hide();
            $('#hero-' + $(this).attr('id')).show();
            $('.menu-heros-lettre').removeClass('active')
            $(this).addClass("active")
        }
    })
    ...
    // MEGA MENU UNIVERS
    $('.menu-univers-liste:not(#univers-1)').hide();
    $('.menu-univers-nom').click(function () {
        $('.menu-univers-liste').hide();
        $('#univers-' + $(this).attr('id')).show();
        $('.menu-univers-nom').removeClass('active')
        $(this).addClass("active")
    })
    ...
    $('#linked-to-gallery a').click(function () {
        ...
        $('#linked-to-gallery a').css('opacity', '0.5');
        $(this).css('opacity', '1');
    ...
    // PAGES COMPTES
    $('.compte .tab-nav a').click(function (e) {
        e.stopImmediatePropagation();
        if ($(this).attr("data-href"))
            window.location = $(this).attr("data-href");
    });

    // PAGE NEWSLETTER (MON COMPTE)
